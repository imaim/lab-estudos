...
print('Valor total pedido2', pedido2, type(pedido2))
...
tiket_medio = (pedido1 + pedido2)/2
print('o tiket médio é', tiket_medio)

# mutiplicação

dias_mes = 22
faturamento = tiket_medio * dias_mes
print('Previsao de faturamento', faturamento)